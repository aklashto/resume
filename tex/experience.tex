  ...
  \cventry
    ...
    {May 2018 -- Aug 2018} % Date(s)
    {
      \begin{cvitems} % Description(s) of tasks/responsibilities
        ...
        \item {Tested embedded programs on NXP microcontroller hardware using an in-circuit debugger and oscilloscope}
...
%---------------------------------------------------------
  \cventry
    ...
    {
      \begin{cvitems} % Description(s) of tasks/responsibilities
        \item {Created an Android incident reporting application to improve incident response time}
      \end{cvitems}
    }
